...
@section('body-header')
    ...
    <p class="crancy-header__text">{{ __('translate.Manage Admin') }} >> {{ __('translate.Create Admin') }}</p>
@endsection
                                    ...
                                    <div class="col-12 mg-top-30">
                                        ...
                                        <div class="crancy-product-card">
                                            ...
                                            <div class="crancy__item-form--group mg-top-25">
                                                ...
                                                <input class="crancy__item-input" type="text" name="name" value="{{ old('name') }}">
                                            </div>

                                            <div class="crancy__item-form--group mg-top-25">
                                                <label class="crancy__item-label crancy__item-label-product">{{ __('translate.Email') }} *</label>
                                                <input class="crancy__item-input" type="email" name="email" value="{{ old('email') }}">
                                            </div>
                                            ...
                                            <div class="crancy__item-form--group mg-top-25">
                                                ...
                                                <select class="form-select crancy__item-input" name="admin_type">
                                                    ...
                                                    <option {{ old('admin_type') == 'super_admin' ? 'selected' : '' }} value="super_admin">{{ __('translate.Super Admin') }}</option>
                                                    <option {{ old('admin_type') == 'restricted_admin' ? 'selected' : '' }} value="restricted_admin">{{ __('translate.Restricted Admin') }}</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="crancy__item-form--group mg-top-25">
                                                ...
                                                <select class="form-select crancy__item-input" name="status">
                                                    <option {{ old('status') == 'enable' ? 'selected' : '' }} value="enable">{{ __('translate.Active') }}</option>
                                                    <option {{ old('status') == 'disable' ? 'selected' : '' }} value="disable">{{ __('translate.Inactive') }}</option>
                                                </select>
                                            </div>
