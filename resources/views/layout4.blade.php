...
<body>
      ...
      <div class="container">
        <div class="td_top_header_in">
          ...
          <div class="td_top_header_right">
            ...
            <span>
              @guest('web')
                <a target="_blank" href="{{ route('student.login') }}" class="">{{ __('translate.Login') }}</a> /
                <a target="_blank" href="{{ route('student.register') }}" class="">{{ __('translate.Register') }}</a>
                @else
        ...
        <div class="td_main_header_in">
          <div class="td_main_header_left">
            ...
            <div class="td_header_social_btns">
                ...
                <a href="{{ $footer->facebook }}" class="td_center">
                <i class="fa-brands fa-facebook-f"></i>
                </a>
                <a href="{{ $footer->twitter }}" class="td_center">
                    <i class="fa-brands fa-x-twitter"></i>
                </a>
                <a href="{{ $footer->instagram }}" class="td_center">
                    <i class="fa-brands fa-instagram"></i>
                </a>
                <a href="{{ $footer->linkedin }}" class="td_center">
              ...
              <button class="td_circle_btn td_center td_search_tobble_btn" type="button">
                <span>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9.65925 19.3084C11.8044 19.3084 13.8882 18.5927 15.5806 17.2745L21.9653 23.6593C22.4423 24.12 23.2023 24.1067 23.663 23.6298C24.1123 23.1645 24.1123 22.4269 23.663 21.9617L17.2782 15.5769C20.5491 11.3664 19.7874 5.30149 15.5769 2.03058C11.3663 -1.24033 5.30149 -0.478645 2.03058 3.7319C-1.24033 7.94244 -0.478646 14.0073 3.73189 17.2782C5.42702 18.5951 7.51269 19.3095 9.65925 19.3084ZM4.52915 4.52545C7.36245 1.6921 11.9561 1.69204 14.7895 4.52535C17.6229 7.35866 17.6229 11.9524 14.7896 14.7857C11.9563 17.6191 7.36261 17.6191 4.52925 14.7858C4.5292 14.7858 4.5292 14.7858 4.52915 14.7857C1.69584 11.973 1.67915 7.3961 4.49181 4.56279C4.50424 4.55031 4.51667 4.53788 4.52915 4.52545Z" fill="white"/>
                    </svg>
                </span>
              ...
              <div class="td_header_search_wrap">
                <form action="{{ route('courses') }}" class="td_header_search">
                  ...
                  <button class="td_header_search_btn td_center">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9.65925 19.3084C11.8044 19.3084 13.8882 18.5927 15.5806 17.2745L21.9653 23.6593C22.4423 24.12 23.2023 24.1067 23.663 23.6298C24.1123 23.1645 24.1123 22.4269 23.663 21.9617L17.2782 15.5769C20.5491 11.3664 19.7874 5.30149 15.5769 2.03058C11.3663 -1.24033 5.30149 -0.478645 2.03058 3.7319C-1.24033 7.94244 -0.478646 14.0073 3.73189 17.2782C5.42702 18.5951 7.51269 19.3095 9.65925 19.3084ZM4.52915 4.52545C7.36245 1.6921 11.9561 1.69204 14.7895 4.52535C17.6229 7.35866 17.6229 11.9524 14.7896 14.7857C11.9563 17.6191 7.36261 17.6191 4.52925 14.7858C4.5292 14.7858 4.5292 14.7858 4.52915 14.7857C1.69584 11.973 1.67915 7.3961 4.49181 4.56279C4.50424 4.55031 4.51667 4.53788 4.52915 4.52545Z" fill="#000"/>
                        </svg>
                  </button>
                </form>
              </div>
  ...
  <div class="td_side_header">
    ...
    <div class="td_side_header_in">
      ...
      <a class="td_site_branding" href="{{ route('home') }}">
        <img src="{{ asset($general_setting->secondary_navmenu_logo) }}" alt="Logo">
      </a>
      <div class="td_side_header_box">
        <h2 class="td_side_header_heading">{{ __('translate.Do you have a project in your') }} <br> {{ __('translate.mind? Keep connect us.') }}</h2>
      </div>
      <div class="td_side_header_box">
        <h3 class="td_side_header_title td_heading_color">{{ __('translate.Contact Us') }}</h3>
        <ul class="td_side_header_contact_info td_mp_0">
          <li>
            <i class="fa-solid fa-phone"></i>
            <span><a href="tel:{{ $footer->phone }}">{{ $footer->phone }}</a></span>
          </li>
          <li>
      ...
      <div class="td_side_header_box">
        <h3 class="td_side_header_title td_heading_color">{{ __('translate.Subscribe') }}</h3>
      ...
      <div class="td_side_header_box">
        <h3 class="td_side_header_title td_heading_color">{{ __('translate.Follow Us') }}</h3>
  ...
  <footer class="td_footer td_style_1">
    <div class="container">
      <div class="td_footer_row">
        <div class="td_footer_col">
          <div class="td_footer_widget">
            <div class="td_footer_text_widget td_fs_18">
                <img src="{{ asset($general_setting->secondary_footer_logo) }}" alt="Logo">
              <p>{{ $footer->about_us }}</p>
            </div>
            <ul class="td_footer_address_widget td_medium td_mp_0">
              ...
              <li><i class="fa-solid fa-location-dot"></i>{{ $footer->address }} <br>{{ $footer->address }}</li>
            </ul>
          </div>
        </div>
        <div class="td_footer_col">
        ...
        <div class="td_footer_col">
          <div class="td_footer_widget">
            <h2 class="td_footer_widget_title td_fs_32 td_white_color td_medium td_mb_30">{{ __('translate.Category') }}</h2>
            <ul class="td_footer_widget_menu">
