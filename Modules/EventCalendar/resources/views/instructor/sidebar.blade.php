<li class="menu-hide {{ Route::is('instructor.zoom-setting') || Route::is('instructor.zoom-meeting.*') || Route::is('instructor.event-calendar') ? 'active' : '' }}"><a href="#!" class="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-zoom_seeting"><span class="menu-bar__text">
