...
class CourseController extends Controller
{
    ...
    public function create()
    {
        ...
        // course language is no longer selected by user, so we don't need to fetch the list
    ...
    public function store(CourseBasicInfoRequest $request)
    {
        ...
        // assign language only if present (field no longer mandatory)
    ...
    public function edit(Request $request, $id)
    {
        ...
        // language list not needed any more
